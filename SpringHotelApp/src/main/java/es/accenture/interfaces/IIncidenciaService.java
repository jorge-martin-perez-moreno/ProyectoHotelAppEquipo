...
public interface IIncidenciaService {
	...
	void guardarIncidencia (Incidencia incidencia); //método donde se meterá la lógica de negocio en IncidenciaService al sobreescribirlo del alta de habitaciones, ojo se llaman igual que el método de IncidenciaDao pero no hacen lo mismo este es para la lógica y el otro para la bbdd
	
	void actualizarIncidencia (Incidencia incidencia); //método donde se meterá la lógica de negocio en IncidenciaService al sobreescribirlo de la modificación de incidencias, ojo se llaman igual que el método de IncidenciaDao pero no hacen lo mismo este es para la lógica y el otro para la bbdd
	...
	List<Incidencia>buscarIncidenciasPorIdHabitacion (int idHabitacion); //método donde se meterá la lógica de negocio en IncidenciaService al sobreescribirlo de la obtención de incidencias de una habitación por el Id de la habitación, ojo! devuelve una lista que es donde se guardarán las incidencias de esa habitación, ojo se llaman igual que el método de IncidenciaDao pero no hacen lo mismo este es para la lógica y el otro para la bbdd
