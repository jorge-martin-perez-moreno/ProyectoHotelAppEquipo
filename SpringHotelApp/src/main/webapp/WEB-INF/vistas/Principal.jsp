...
<body>
    ...
    <div class="welcome-card">
        ...
        <!-- Menú de navegación -->
        <nav class="nav-menu">
            <a href="${pageContext.request.contextPath}/habitaciones" class="nav-link">Habitaciones</a>
            <span class="nav-separator">|</span>
            <a href="${pageContext.request.contextPath}/huespedes" class="nav-link">Huéspedes</a>
            <span class="nav-separator">|</span>
            <a href="${pageContext.request.contextPath}/reservas" class="nav-link">Reservas</a>
            <span class="nav-separator">|</span>
            <a href="${pageContext.request.contextPath}/incidencias" class="nav-link">Incidencias</a>
            <span class="nav-separator">|</span>
            <a href="${pageContext.request.contextPath}/usuarios/logout" class="nav-link nav-logout">Cerrar sesión</a>
        </nav>
